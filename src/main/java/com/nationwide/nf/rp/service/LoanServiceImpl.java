...
public class LoanServiceImpl implements LoanService {
    ...
    private AspectMiningResult aspectMiningResult;
    private Object aspectMiningByCategory;
    ...
    public AspectMiningResult updateAspectMine(AspectMine aspectMine) {
        log.info(aspectMine);
        AspectMiningResult aspectMineResult = getAspectMiningResult();
        log.info(aspectMineResult);
        log.info("Aspect mining was successful");
        return aspectMineResult;
    }
    ...
    public AspectMiningResult getAspectMiningResult() {
        AspectMiningResult aspectMiningResult = new AspectMiningResult();
        aspectMiningResult.setStatus("Success");
        aspectMiningResult.setAspectMiningSummary(getAspectMiningSummary());
    ...
    public AspectMiningByCategory[] getAspectMiningByCategory() {
        AspectMiningByCategory[] aspectMiningByCategories = new AspectMiningByCategory[3];
